...
--
-- Name: publication_vectors; Type: TABLE; Schema: public; Owner: -
--

CREATE TABLE public.publication_vectors (
    id uuid DEFAULT gen_random_uuid() NOT NULL,
    key character varying NOT NULL,
    publication_id uuid NOT NULL,
...
--
-- Name: publication_vectors publication_vectors_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.publication_vectors
    ADD CONSTRAINT publication_vectors_pkey PRIMARY KEY (id);
...
--
-- Name: index_authors_on_person_type_and_person_id; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX index_authors_on_person_type_and_person_id ON public.authors USING btree (person_type, person_id);


--
-- Name: index_authors_on_publication_id; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX index_authors_on_publication_id ON public.authors USING btree (publication_id);


--
-- Name: index_publication_vectors_on_key; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX index_publication_vectors_on_key ON public.publication_vectors USING btree (key);


--
-- Name: index_publication_vectors_on_publication_id; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX index_publication_vectors_on_publication_id ON public.publication_vectors USING btree (publication_id);
...
--
-- Name: index_students_on_course_id; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX index_students_on_course_id ON public.students USING btree (course_id);
...
--
-- Name: authors fk_rails_61b8de26c5; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.authors
    ADD CONSTRAINT fk_rails_61b8de26c5 FOREIGN KEY (publication_id) REFERENCES public.publications(id);
...
--
-- Name: students fk_rails_a258d82422; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.students
    ADD CONSTRAINT fk_rails_a258d82422 FOREIGN KEY (course_id) REFERENCES public.courses(id);


--
-- Name: publication_vectors fk_rails_a9cb1cd039; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.publication_vectors
    ADD CONSTRAINT fk_rails_a9cb1cd039 FOREIGN KEY (publication_id) REFERENCES public.publications(id);
